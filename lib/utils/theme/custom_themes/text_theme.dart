...
class MyTextTheme{
 ...
 static TextTheme LightTextTheme = TextTheme(
   ...
   titleSmall: const TextStyle().copyWith(fontSize: 24,fontWeight: FontWeight.w400,color: Colors.black),
 ...
 static TextTheme DarkTextTheme = TextTheme(
   ...
   titleSmall: const TextStyle().copyWith(fontSize: 24,fontWeight: FontWeight.w400,color: Colors.white),
