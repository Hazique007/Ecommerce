...
class ImagesStrings{
  ...
  //--Lottie animations
  static String cartAnimation = "assets/images/animations/lady-adding-product-in-cart-anination.json";
  static String orderCompletedAnimotion = "assets/images/animations/order-complete-car-delivery-animation.json";
  ...
  static String emptyAnimation = "assets/images/aninations/72785-searching.json";
  ...
  static String thankYouAnimation = "assets/images/animations/184368-thank-you.json";
  static String paymentSuccessfulAnimation="assets/images/animations/120978-payment-successful.json";
  static String loodingJuggleAnimation ="assets/images/animations/141397-Loading-juggle.json";
